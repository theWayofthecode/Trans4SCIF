...
cmake ../../ -DCMAKE_CXX_COMPILER=icpc -DCMAKE_C_COMPILER=icc -DINSTALL_PATH=lib
cd ../
...
env CFLAGS="-mmic" CXXFLAGS="-mmic" cmake ../../ -DCMAKE_CXX_COMPILER=icpc -DCMAKE_C_COMPILER=icc -DINSTALL_PATH=/usr/linux-k1om-4.7/linux-k1om/usr/lib64
cd ../
